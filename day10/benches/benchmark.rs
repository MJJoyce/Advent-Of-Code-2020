...
fn part2_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("day 10 part 2", |b| b.iter(|| part2(black_box(&input_data))));
    group.bench_function("day 10 part 2 min mem", |b| b.iter(|| part2_min_mem(black_box(&input_data))));
    group.finish();
}
